...
const uint32_t sl_rail_ble_phy_2Mbps_aox_39MHz_0_34_modemConfig[] = {
  0x03014FFCUL, (uint32_t) &phyInfo_1,
  0x00014010UL, 0x00004101UL,
  0x0001403CUL, 0x00000000UL,
  0x00014048UL, 0x030007A0UL,
...
const RAIL_ChannelConfigEntry_t sl_rail_ble_phy_2Mbps_aox_39MHz_channels[] = {
  {
    .phyConfigDeltaAdd = sl_rail_ble_phy_2Mbps_aox_39MHz_0_34_modemConfig,
    .baseFrequency = 2402000000,
    .channelSpacing = 2000000,
    .physicalChannelOffset = 0,
    .channelNumberStart = 0,
...
const RAIL_ChannelConfig_t sl_rail_ble_phy_2Mbps_aox_39MHz_channelConfig = {
  .phyConfigBase = sl_rail_ble_phy_1Mbps_viterbi_39MHz_modemConfigBase,
  .phyConfigDeltaSubtract = NULL,
  .configs = sl_rail_ble_phy_2Mbps_aox_39MHz_channels,
  .length = 6U,
  .signature = 0UL,
  .xtalFrequencyHz = 39000000UL,
};
