...
#ifndef SL_CPC_DRV_SPI_EXP_RX_IRQ_PORT          
#define SL_CPC_DRV_SPI_EXP_RX_IRQ_PORT           gpioPortA
#endif
#ifndef SL_CPC_DRV_SPI_EXP_RX_IRQ_PIN           
